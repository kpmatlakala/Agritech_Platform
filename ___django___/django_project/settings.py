...
STATIC_URL = '/static/'
# Path where static files are collected (in production)
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Add 'static' directory for each app (if you have more than one app)
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'django_project/static'),  # Adjust this to your app's static directory
]
...
# settings.py
OPENWEATHER_API_KEY = '895284fb2d2c50a520ea537456963d9c'
